...
print "The input file is %d bytes long" % len(indata)           #size of item1

print "Does the output file exist? %r" % exists(to_file)        #check item2 in folder
print "Ready, hit RETURN to continue, CTRL-C to abort."
raw_input()                                             #to start copying
